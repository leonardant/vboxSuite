...
{
    [WebHostHidden]
    public abstract class VideoDataCommon : BindableBase
    {
    ...
    public class VideoDataItem : VideoDataCommon
    {
        ...
        public VideoDataItem(int id, String title, String imgPath, StorageFile file)
            : base(id, title)
        {
            this.file = file;
        ...
        public VideoDataItem(int id, String title, String imgPath, StorageFolder dir)
            : base(id, title)
        {
            this.dir = dir;
            this.imgPath = imgPath;
        ...
        public VideoDataItem(int id, String title, String imgPath)
            : base(id, title)
        {
            this.imgPath = imgPath;
        }
    ...
    public class VideoDataGroup : VideoDataCommon
    {
        ...
        public VideoDataGroup(int id, String title)
            : base(id, title)
        {
